...
const standarConnection = [
    [0, 1],
    [0, 3],
    [1, 3],
  ],
  standarEdges = [
    { nodeSrc: 0, nodeDest: 1, weight: 0 },
    { nodeSrc: 0, nodeDest: 3, weight: 0 },
    { nodeSrc: 1, nodeDest: 3, weight: 0 },
  ],
  directedConnection = [
    [0, 1],
    [0, 3],
...
const connectNodes = (arr: number[][], withObject: boolean) => {
  arr.forEach((connect) => {
    ...
    else graph.connectNodes(connect[0], connect[1]);
  });
};
